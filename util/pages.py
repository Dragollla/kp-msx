...
888    Y88b 888             888       888  "Y8888P" d88P   Y88b 
    ...
    <span class="roboto">
        ...
        <p>Если при вводе адреса возникает ошибка и доступна кнопка с иконкой замка, её нужно нажать, чтобы в строке ввода адреса появился замок</p>
        <p>При возникновении проблем, вопросов, пожеланий, предложений при использовании этой версии не обращайтесь в поддержку кинопаба, а напишите Issue по ссылке далее<p>
        <p><b>Для того, чтобы сделать личную копию такого сервиса или узнать больше, прочитайте, что написано <a href="https://github.com/slonopot/kp-msx">здесь</a>, и следуйте инструкциям по ссылке</b></p>
